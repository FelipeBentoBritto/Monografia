...
public class ConTermoEntregaChaves extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConTermoEntregaChaves frame = new ConTermoEntregaChaves();
	 ...
	 * Create the frame.
	 */
	public ConTermoEntregaChaves() {
		setTitle("Consulta de Termo de Entrega de Chaves");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"C\u00F3digo", "Locat\u00E1rio", "Endere\u00E7o", "N\u00FAmero", "Bairro", "Complemento", "CEP", "Situa\u00E7\u00E3o", "Data de Assinatura"
			}
		));
		...
		button.setIcon(new ImageIcon(ConTermoEntregaChaves.class.getResource("/Imagens/Actions-go-first-view-icon.png")));
		...
		button_1.setIcon(new ImageIcon(ConTermoEntregaChaves.class.getResource("/Imagens/Actions-go-previous-view-icon.png")));
		...
		label_2.setIcon(new ImageIcon(ConTermoEntregaChaves.class.getResource("/Imagens/Basic-Minus-icon.png")));
		...
		button_2.setIcon(new ImageIcon(ConTermoEntregaChaves.class.getResource("/Imagens/Actions-go-next-view-icon.png")));
		...
		button_3.setIcon(new ImageIcon(ConTermoEntregaChaves.class.getResource("/Imagens/Actions-go-last-view-icon.png")));
		...
		button_4.setIcon(new ImageIcon(ConTermoEntregaChaves.class.getResource("/Imagens/logout-icon.png")));
