...
public class ConRenovacao extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConRenovacao frame = new ConRenovacao();
	 ...
	 */
	public ConRenovacao() {
		setTitle("Consulta de Renova\u00E7\u00E3o");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"C\u00F3digo", "Locat\u00E1rio", "Endere\u00E7o", "N\u00FAmero", "Bairro", "Complemento", "CEP", "Valor Aluguel", "\u00CDnicio de Vig\u00EAncia", "Prazo Reajuste", "Pr\u00F3ximo Reajuste", "Porcentagem de Reajuste", "Vencimento", "Situa\u00E7\u00E3o", "Data de Assinatura"
			}
		));
		...
		button.setIcon(new ImageIcon(ConRenovacao.class.getResource("/Imagens/Actions-go-first-view-icon.png")));
		...
		button_1.setIcon(new ImageIcon(ConRenovacao.class.getResource("/Imagens/Actions-go-previous-view-icon.png")));
		...
		label_2.setIcon(new ImageIcon(ConRenovacao.class.getResource("/Imagens/Basic-Minus-icon.png")));
		...
		button_2.setIcon(new ImageIcon(ConRenovacao.class.getResource("/Imagens/Actions-go-next-view-icon.png")));
		...
		button_3.setIcon(new ImageIcon(ConRenovacao.class.getResource("/Imagens/Actions-go-last-view-icon.png")));
		...
		button_4.setIcon(new ImageIcon(ConRenovacao.class.getResource("/Imagens/logout-icon.png")));
