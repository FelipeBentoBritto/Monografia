...
public class Imovel {
	...
	public Imovel(int id, int idTipoImovel, int idProprietario, String endereco, int numero, String complemento, String bairro, String cep, String descricao, Double taxaAdm, Double valorImovel, Double areaTe,
