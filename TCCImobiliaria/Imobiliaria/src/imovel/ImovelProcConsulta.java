...
public class ImovelProcConsulta {
	private int id;
	...
	public ImovelProcConsulta(int id, Integer idTipoImovel, String nomeTipoImovel, Integer idProprietario, String nomeProprietario, String razaoSocialProprietaro,
			Integer idCidade, String nomeCidade, String ufCidade, String enderecoProprietario, int numeroProprietario, 
			String complementoProprietario, String bairroProprietario, String cpfProprietario,
			String cnpjProprietario, String tipoPessoaProprietario, String estadoCivilProprietario, String nomeConjuge, String cpfConjuge,
			String enderecoImovel, int numeroImovel, String complementoImovel, String bairroImovel, String ativo) {
