...
public class ConPS extends JFrame {
	 ...
	 */
	public ConPS() {
		setTitle("Consulta de Prestador de Servi\u00E7o");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"C\u00F3digo", "Nome", "Telefone Fixo", "Telefone Celular", "Telefone Comercial", "Email", "Fun\u00E7\u00E3o", "Tipo de Pessoa"
			}
		));
		...
		button.setIcon(new ImageIcon(ConPS.class.getResource("/Imagens/Actions-go-first-view-icon.png")));
		...
		button_1.setIcon(new ImageIcon(ConPS.class.getResource("/Imagens/Actions-go-previous-view-icon.png")));
		...
		label_1.setIcon(new ImageIcon(ConPS.class.getResource("/Imagens/Basic-Minus-icon.png")));
		...
		button_2.setIcon(new ImageIcon(ConPS.class.getResource("/Imagens/Actions-go-next-view-icon.png")));
		...
		button_3.setIcon(new ImageIcon(ConPS.class.getResource("/Imagens/Actions-go-last-view-icon.png")));
		...
		button_4.setIcon(new ImageIcon(ConPS.class.getResource("/Imagens/logout-icon.png")));
