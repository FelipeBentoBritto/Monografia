...
public class ConContratoAdm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConContratoAdm frame = new ConContratoAdm();
	 ...
	 * Create the frame.
	 */
	public ConContratoAdm() {
		setTitle("Consulta de Contrato de Administra\u00E7\u00E3o");
		...
		panel_3.setBounds(308, 0, 351, 62);
		panel.add(panel_3);
		panel_3.setLayout(null);
		
		JLabel lblSelecioneOModo = new JLabel("Selecione o Modo de Consulta:");
		lblSelecioneOModo.setBounds(10, 11, 236, 14);
		panel_3.add(lblSelecioneOModo);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"C\u00F3digo", "Propriet\u00E1rio", "Endere\u00E7o", "N\u00FAmero", "Bairro", "Complemento", "Valor", "Taxa de Adm", "Situa\u00E7\u00E3o", "Data de Assinatura"
			}
		));
		...
		button.setIcon(new ImageIcon(ConContratoAdm.class.getResource("/Imagens/Actions-go-first-view-icon.png")));
		...
		button_1.setIcon(new ImageIcon(ConContratoAdm.class.getResource("/Imagens/Actions-go-previous-view-icon.png")));
		...
		label_1.setIcon(new ImageIcon(ConContratoAdm.class.getResource("/Imagens/Basic-Minus-icon.png")));
		...
		button_2.setIcon(new ImageIcon(ConContratoAdm.class.getResource("/Imagens/Actions-go-next-view-icon.png")));
		...
		button_3.setIcon(new ImageIcon(ConContratoAdm.class.getResource("/Imagens/Actions-go-last-view-icon.png")));
		...
		button_4.setIcon(new ImageIcon(ConContratoAdm.class.getResource("/Imagens/logout-icon.png")));
