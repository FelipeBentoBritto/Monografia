...
public class ConRepasse extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConRepasse frame = new ConRepasse();
	...
	public ConRepasse() {
		...
		JRadioButton rdbtnNomeDoProprietrio = new JRadioButton("Nome do Propriet\u00E1rio");
		rdbtnNomeDoProprietrio.setBounds(189, 7, 156, 23);
		panel_1.add(rdbtnNomeDoProprietrio);
		
		JRadioButton radioButton_1 = new JRadioButton("Endere\u00E7o do Im\u00F3vel");
		radioButton_1.setBounds(189, 35, 156, 23);
		panel_1.add(radioButton_1);
		
		JLabel label_2 = new JLabel("Pesquisar Parcela:");
		label_2.setBounds(10, 44, 193, 14);
		panel.add(label_2);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(10, 60, 86, 20);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"C\u00F3digo", "Parcela", "Propriet\u00E1rio", "Endere\u00E7o", "N\u00FAmero", "Bairro", "Complemento", "CEP", "Valor Aluguel", "Valor da Taxa de Adm", "Decr\u00E9scimo", "Valor Repasse", "Data de Vencimento", "Situa\u00E7\u00E3o", "Forma de Pagamento"
			}
		));
		...
		table.getColumnModel().getColumn(11).setMinWidth(110);
		...
		button.setIcon(new ImageIcon(ConRepasse.class.getResource("/Imagens/Actions-go-first-view-icon.png")));
		...
		button_1.setIcon(new ImageIcon(ConRepasse.class.getResource("/Imagens/Actions-go-previous-view-icon.png")));
		...
		label_3.setIcon(new ImageIcon(ConRepasse.class.getResource("/Imagens/Basic-Minus-icon.png")));
		...
		button_2.setIcon(new ImageIcon(ConRepasse.class.getResource("/Imagens/Actions-go-next-view-icon.png")));
		...
		button_3.setIcon(new ImageIcon(ConRepasse.class.getResource("/Imagens/Actions-go-last-view-icon.png")));
		...
		button_4.setIcon(new ImageIcon(ConRepasse.class.getResource("/Imagens/logout-icon.png")));
