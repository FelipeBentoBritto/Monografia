...
public class ConRescisaoContrato extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConRescisaoContrato frame = new ConRescisaoContrato();
	 ...
	 * Create the frame.
	 */
	public ConRescisaoContrato() {
		setTitle("Consulta de Rescis\u00E3o");
		...
		JRadioButton radioButton = new JRadioButton("Nome do Locat\u00E1rio");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"C\u00F3digo", "Locat\u00E1rio", "Endere\u00E7o", "N\u00FAmero", "Bairro", "Complemento", "Data Vencimento", "Valor", "Data da Rescis\u00E3o", "Situa\u00E7\u00E3o"
			}
		));
		...
		button.setIcon(new ImageIcon(ConRescisaoContrato.class.getResource("/Imagens/Actions-go-first-view-icon.png")));
		...
		button_1.setIcon(new ImageIcon(ConRescisaoContrato.class.getResource("/Imagens/Actions-go-previous-view-icon.png")));
		...
		label_2.setIcon(new ImageIcon(ConRescisaoContrato.class.getResource("/Imagens/Basic-Minus-icon.png")));
		...
		button_2.setIcon(new ImageIcon(ConRescisaoContrato.class.getResource("/Imagens/Actions-go-next-view-icon.png")));
		...
		button_3.setIcon(new ImageIcon(ConRescisaoContrato.class.getResource("/Imagens/Actions-go-last-view-icon.png")));
		...
		button_4.setIcon(new ImageIcon(ConRescisaoContrato.class.getResource("/Imagens/logout-icon.png")));
